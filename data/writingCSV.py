...
OSM_PATH = "new-york_new-york.osm"
...
expected = ["Street", "Avenue","Broadway", "Boulevard", "Drive", "Court", "Place", "Square", "Lane", "Road",
            "Trail", "Parkway", "Commons", "Way", "Terrace", "Walk","Alley", "Circle", "Crescent", "Highway", "Lane", "Path", "Plaza", "Real", "Parkway","West","Turnpike","South","Roadbed","Park","North","Loop","Green","East"]
...
def update_name(name, mapping):
    ...
    for w in range(len(words)):
        if words[w] in mapping:
            if words[w].lower() not in ['suite', 'ste.', 'ste', 'bld','bldg']:
